...
//        //  Для примера Logger (чистое логирование):
...
//        // -----
        ...
        return repository.findAll()
                .stream()
                //.filter(Product::isActive)  -> метод reference
                .filter(x -> x.isActive())
                //.map(mappingService::mapEntityToDto)  -> метод reference
